...
// shared /login route (see redirect-policy.ts: ?next= carries which door
// the browser was headed through) rather than two pages that would drift
// out of sync with the actual auth system.
...
export default async function LoginPage({
  ...
  const variantKey = next.startsWith("/coach") ? "coach" : "cockpit";
