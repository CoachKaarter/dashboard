...
export function NavLink({
  ...
  return (
    <Link
      href={href}
      className={`flex items-center gap-2.5 w-full h-[31px] px-2.5 mb-px rounded-md text-[12.5px] transition-colors ${
    ...
    >
      <span
        className={`w-1 h-1 rounded-full shrink-0 ${active ? "bg-green" : "bg-white/15"}`}
      />
